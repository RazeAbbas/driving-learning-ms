                                                ...
                                                <div class="dropdown-menu dropdown-menu-end">
                                                    ...
                                                    <div class="btn-group dropleft">
                                                        ...
                                                        <div class="dropdown-menu">
                                                            <a class="dropdown-item" href="{{ url('admin/assessment/' . $val['course_id'] . '/' . $val['id'] . '/create') }}">Add Quiz</a>
                                                            <a class="dropdown-item" href="{{ url('admin/chapter/' . $val['course'][$module['db_key']] . '/' . $val[$module['db_key']]) }}">View
                                                                Chapters</a>
                                                            <a class="dropdown-item" href="#data_modal" data-toggle="modal"
                                                                data-url="{{ $action }}/edit/{{ $val[$module['db_key']] }}"
                                                                data-action="data_modal">
                                                                Edit Lesson </a>
