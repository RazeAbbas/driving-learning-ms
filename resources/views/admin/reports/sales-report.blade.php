                ...
                <form method="get" action="">
                    ...
                    <div class="row card-body">
                        ...
                        <div class="col-lg-4 col-md-4 mt-2">
                            ...
                            <input type="date" name="start_date" id="start_date" max="{{ date("Y-m-d") }}" value="{{ @$start_date }}" class="form-control">
                        </div>
                        <div class="col-lg-4 col-md-4 mt-2">
                            <label for="end_date" class="form-label">End Date</label>
                            <input type="date" name="end_date" id="end_date" max="{{ date("Y-m-d") }}" value="{{ @$end_date }}" class="form-control">
                        </div>
                        {{-- <div class="col-lg-4 col-md-4 mt-2">
                    ...
                    @php
                        ...
                        if(!empty(@$end_date)){
                            if (empty($url_params)) {
                                ...
                                $url_params = $url_params."&end_date=".@$end_date;
                            }
                        }
                    @endphp
