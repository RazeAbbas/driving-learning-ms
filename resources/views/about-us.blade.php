        ...
        <div class="row align-items-center">
            ...
            <div class="col-xl-6 col-lg-12 pl--60 pl_md--10 pl_sm--10 pt--50">
                <div class="title-area-left-style">
                    ...
                    <h2 class="title">Know NEMT-GUARD Empowering
                    ...
                    <div class="author-area">
                        <div class="single-author-and-info">
                            ...
                            <div class="information">
                                ...
                                <p class="desig">CEO, NEMT-GUARD Online Education</p>
                            </div>
                        </div>
                        <a href="mailto:support@nemtguard.com" class="rts-btn btn-primary">Call to Action</a>
                    </div>
                </div>
            </div>
        </div>
...
{{-- <div class="fun-facts-area-1 bg_image ptb--50 mb-5">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
...
<div class="why-choose-us bg-blue bg-choose-us-one bg_image rts-section-gap shape-move mt-5">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-6">
                <div class="why-choose-us-area-image pb--50">
                    <img class="one" src="assets/images/why-choose/nemtt2.png" alt="why-choose">
                    <div class="border-img">
                        <img class="two ml--20" src="assets/images/why-choose/nemt_aboutus.png" alt="why-choose">
                    </div>
            ...
            <div class="col-lg-6 pl--90 pl_sm--15 pt_sm--50">
                <div class="title-area-left-style">
                    ...
                    <h2 class="title">NEMTGUARD Your Path to
                        Excellence & Success</h2>
                    <p class="post-title">Our platform offers a dynamic blend of interactive courses, real-world scenarios, and expert guidance, 
                        <br>designed to equip NEMT drivers with the skills and knowledge necessary to navigate diverse transportation challenges.  
                    </p>
                </div>
                ...
                <a href="{{url('courses')}}" class="rts-btn btn-primary-white with-arrow">View All Courses <i class="fa-regular fa-arrow-right"></i></a>
            </div>
        </div>
    </div>
