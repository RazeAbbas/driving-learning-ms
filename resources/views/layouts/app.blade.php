...
<body>
                            ...
                            <div class="actions-area">
                                ...
                                @endif
                                    <div class="position-relative">
                                        ...
                                        <span class="position-absolute top-0 start-100 translate-middle badge rounded-pill" style="background-color: #235347" id="cart-qty">
    ...
    <div class="footer-callto-action-area bg-dark-footer-1 mt-5">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="footer-one-main-wrapper">
                        ...
                        <div class="footer-singl-wized left-logo">
                            <div class="head">
                                <a href="#">
                                    <img src="{{ asset('assets/images/logo/nemt_dark.png') }}" alt="logo"
                                        loading="lazy" />
                                </a>
                            </div>
                            <div class="body">
                                <p class="dsic">
                                    Our program is crafted to equip drivers with the skills, knowledge, 
                                    and mindset necessary to provide exceptional care while ensuring the highest standards of safety.
                                    
                                </p>
                                <ul class="wrapper-list">
                                    {{-- <li>
                                        <i class="fa-regular fa-location-dot"></i> New York
                                    </li> --}}
                                    
                                    <li>
                                        <a href="mailto:support@nemtguard.com"><i class="fas fa-mail-bulk"></i>support@nemtguard.com</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        {{-- <div class="footer-singl-wized">
                            <div class="head">
                                <h6 class="title">Online Platform</h6>
                            </div>
                            <div class="body">
                                <ul class="menu">
                        ...
                        {{-- <div class="footer-singl-wized input-area">
                            ...
                            <div class="body">
                                <div class="d-flex">
                                    <a href="#" class="me-5"><i class="fa-brands fa-facebook-f"></i></a>
                                    <a href="#" class="me-5"><i class="fa-brands fa-instagram"></i></a>
                                    <a href="#" class="me-5"><i class="fa-brands fa-linkedin"></i></a>
                                    <a href="#" class="me-5"><i class="fa-brands fa-pinterest"></i></a>
                                    <a href="#" class="me-5"><i class="fa-brands fa-youtube"></i></a>
    ...
    <!-- Modal -->
    {{-- <div class="modal login-pupup-modal fade" id="exampleModal-login" tabindex="-1"
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if (response.error == false) {
                            toastr.success('Course added to wishlist!');
                        } else {
                            toastr.error('Course already exist in wishlist');
                        }
                    },
