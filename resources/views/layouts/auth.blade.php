                ...
                <div class="col-lg-12">
                    <div class="header-tranaparent-main-wrapper">
                        <a href="{{url('/')}}" class="py-3 d-block">
                            <img src="{{asset('assets/images/logo/nemt_white_header_icon.png')}}" width="270" alt="logo">
                        </a>
                        <div class="right-area">
                            ...
                            <a href="{{url('login')}}" class="rts-btn btn-primary-white">Login</a>
                            <a href="{{url('register')}}" class="rts-btn btn-primary-white">Sign Up</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <ul class="mainmenu metismenu" id="mobile-menu-active">
                    <li class="has-droupdown">
                        ...
                        <ul class="submenu mm-collapse">
                            <li><a class="mobile-menu-link" href="{{url('/')}}">Main Home</a></li>
                    ...
                    <li class="has-droupdown">
                        ...
                        <ul class="submenu mm-collapse">
                            ...
                            <li><a class="mobile-menu-link" href="single-course-three.html">Courses Details V3</a>
                            </li>
                            ...
                            <li><a class="mobile-menu-link" href="single-course-free.html">Courses Details Free</a>
                            </li>
                        </ul>
                        <ul class="submenu mm-collapse">
                            <li><a href="#" class="tag">Others</a></li>
                            <li><a class="mobile-menu-link" href="become-instructor.html">Become an Instructor</a>
                            </li>
