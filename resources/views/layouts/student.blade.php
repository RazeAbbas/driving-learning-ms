                ...
                <div class="col-lg-12">
                    <div class="dashboard-banner-area-start bg_image  student-dashboard">
                        ...
                        <div class="author-profile-image-and-name">
                            <div class="profile-pic p-0">
                                @if (!empty($student->image))
                                    <img src="{{ asset('storage/images/' . Auth::user()->image) }}" width="200"
                                        height="200" alt="Student Image">
                                @else
                                    <img src="{{ asset('assets/images/dashboard/profile.png') }}" width="200"
                            ...
                            <div class="name-desig">
                                ...
                                <div class="course-vedio">
                                    <div class="single">
                                        ...
                                        <span>{{ $course_count }} Course Enrolled</span>
                                    </div>
                                    <div class="single">
                ...
                <div class="col-lg-3">
                    <div class="left-sindebar-dashboard">
                        <div class="dashboard-left-single-wrapper">
                            <!-- single item -->
                            <a href="{{ url('student/dashboard') }}" class="single-item @if($active == 'dashboard') active @endif">
                                <i class="fa-light fa-house"></i>
                                <p>Dashboard</p>
                            </a>
                            <!-- single item end -->
                            <!-- single item -->
                            <a href="{{ url('student/courses') }}" class="single-item @if($active == 'enrolled_courses') active @endif">
                                <i class="fa-light fa-graduation-cap"></i>
                                <p>Enrolled Courses</p>
                            </a>
                            <!-- single item end -->
                            <!-- single item -->
                            <a href="{{ url('student/wishlist') }}" class="single-item @if($active == 'wishlist') active @endif">
                        ...
                        <div class="dashboard-left-single-wrapper bbnone mt--40">
                            ...
                            <!-- single item -->
                            <a href="{{ url('student/profile') }}" class="single-item @if($active == 'profile') active @endif">
                            ...
                            <form id="logout-form" action="{{ url('logout') }}" method="POST" class="d-inline">
                                @csrf
                                <button type="submit" class="single-item" style="border: none; background: none; cursor: pointer;">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="footer-dashboard-inner">
                        <p>Copyright © 2024 All Rights Reserved by <a href="{{url('https://www.nemtguard.com')}}">NEMTGuard</a></p>
                        <a href="{{url('/')}}">
